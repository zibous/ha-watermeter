...
class Calculator:
    ...
    def __init__(self, mqttClient, data: str = ''):
    ...
    def __publishData__(self):
        log.info('✔︎ Publish data')
    ...
    def __doCalc__(self):
        ...
        try:
            ...
            elapsed_time = current_dts - previous_dts
            ...
            if(self.pd):
                ...
                # check update last totol for hour    
                ...
                # check update last totol for day
                ...
                # check update last totol for month    
                ...
                # check update last totol for year
            ...
            self.cd['elapsed_time'] = str(elapsed_time)
            self.cd['last_update'] = now.strftime('%Y-%m-%d %H:%M:%S.%f')
            self.cd['data_provider'] = SERVER_TAG
